/************************************************************
  ...
  Description:    数据表Xt_course_test对应的业务逻辑层Xt_course_test
  Version:         2.1.0.0
  * 对此文件的更改可能会导致不正确的行为，并且如果
     重新生成代码，这些更改将会丢失。您可以扩展该类
 * 实现自己的 Xt_course_test_Entity:Xt_course_test
 * 
************************************************************/
/************************************************************
SQL代码：
...
namespace AgileFrame.Orm.PersistenceLayer.Model
{
    /// <summary>
    /// <para>课程测试关联表</para>
    /// <para>与Xt_course_test数据表对应的实体对象。</para>
    ...
    public class Xt_course_test : ITableImplement
    {
        ...
        {
            return (Xt_course_test)this.MemberwiseClone(); //浅复制
        }
        #endregion
