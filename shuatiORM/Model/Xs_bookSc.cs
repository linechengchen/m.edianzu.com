/************************************************************
  ...
  Description:    数据表Xs_bookSc对应的业务逻辑层Xs_bookSc
  Version:         2.1.0.0
  * 对此文件的更改可能会导致不正确的行为，并且如果
     重新生成代码，这些更改将会丢失。您可以扩展该类
 * 实现自己的 Xs_bookSc_Entity:Xs_bookSc
 * 
************************************************************/
/************************************************************
SQL代码：
select AutoId,BookId,Sc from Xs_bookSc
delete from Xs_bookSc
INSERT INTO Xs_bookSc (AutoId,BookId,Sc)
     VALUES
           ('','','')
UPDATE Xs_bookSc SET ...
变量赋值代码：
...
namespace AgileFrame.Orm.PersistenceLayer.Model
{
    /// <summary>
    /// <para>图书销售</para>
    /// <para>与Xs_bookSc数据表对应的实体对象。</para>
    /// <para>增加一个数据列的方法是：在"类字段"节增加一个bool标识位，与"Attribute"属性 </para>
    /// </summary>    
    [Serializable]
    public class Xs_bookSc : ITableImplement
    {
        /// <summary>工厂方法  </summary>
        public static Xs_bookSc Factory()
        {
            return new Xs_bookSc();
        }
        ...
        public class Attribute
        {
            ...
            public static AttributeItem AutoId =  new AttributeItem("[Xs_bookSc].[AutoId]", typeof(int), 4, default(int));
            
            /// <summary>本书的ID:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem BookId =  new AttributeItem("[Xs_bookSc].[BookId]", typeof(int), 4, default(int));
            
            /// <summary>源（学校）:[CtrlTypeDic-{InputString}]</summary>
            public static AttributeItem Sc =  new AttributeItem("[Xs_bookSc].[Sc]", typeof(int), 4, default(int));
        }
        #endregion
        #region bool清单 辅助设计
        ...
        /// <summary></summary>
        public new Xs_bookSc Clone()
        {
            return (Xs_bookSc)this.MemberwiseClone(); //浅复制
        }
        #endregion
        ...
        public Xs_bookSc(bool IsLoadAllAttributes):base(IsLoadAllAttributes) { }
        /// <summary>实现分表功能，修改表名  </summary>
        //public Xs_bookSc(string tableName):base(tableName) { }
        /// <summary>实现分表功能，自定义实例的初始化  </summary>
        //public Xs_bookSc(string tableName, params AttributeItem[] attrs) : base(tableName, attrs) { }
        /// <summary>实现快捷功能  </summary>
        //public Xs_bookSc(params AttributeItem[] attrs) : base(attrs) { }
        
        /// <summary>请注意，这里当表中仅存在一个字段的时候，将可能与构造函数 new Table(string tableName)冲突  </summary>
        public Xs_bookSc(int autoid1, int bookid1, int sc1)
        {
        ...
        public static Xs_bookSc FromIView(IView view)
        {
            return (Xs_bookSc)IView.GetITable(view, "Xs_bookSc");
        }
        /// <summary>获得一个实例  </summary>
        public static Xs_bookSc GetOneInstance()
        {
            Xs_bookSc value = new Xs_bookSc();
            return value;
        }
        /// <summary>获取单一实例==BLLTable.GetRowData(); </summary>
        public Xs_bookSc Retrieve()
        {
            BLLTable<Xs_bookSc>.GetRowData(this);
            return this;
        }
        #endregion
