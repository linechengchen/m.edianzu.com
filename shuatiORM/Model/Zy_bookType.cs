/************************************************************
  ...
  Description:    数据表Zy_bookType对应的业务逻辑层Zy_bookType
  Version:         2.1.0.0
  * 对此文件的更改可能会导致不正确的行为，并且如果
     重新生成代码，这些更改将会丢失。您可以扩展该类
 * 实现自己的 Zy_bookType_Entity:Zy_bookType
 * 
************************************************************/
/************************************************************
SQL代码：
...
namespace AgileFrame.Orm.PersistenceLayer.Model
{
    /// <summary>
    /// <para>本书分类</para>
    /// <para>与Zy_bookType数据表对应的实体对象。</para>
    ...
    public class Zy_bookType : ITableImplement
    {
        ...
        {
            return (Zy_bookType)this.MemberwiseClone(); //浅复制
        }
        #endregion
