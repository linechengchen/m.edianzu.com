...
namespace AgileFrame.Orm.PersistenceLayer.Model
{
    ...
    public class St_TTimuDaXue : ITableImplement
    {
        ...
        public class Attribute
        {
            ...
            public static AttributeItem Answer =  new AttributeItem("[St_TTimuDaXue].[Answer]", typeof(string), 3000, default(string));
            ...
            public static AttributeItem Question =  new AttributeItem("[St_TTimuDaXue].[Question]", typeof(string), 3000, default(string));
