/************************************************************
  ...
  Description:    数据表Xt_student_task对应的业务逻辑层Xt_student_task
  Version:         2.1.0.0
  * 对此文件的更改可能会导致不正确的行为，并且如果
     重新生成代码，这些更改将会丢失。您可以扩展该类
 * 实现自己的 Xt_student_task_Entity:Xt_student_task
 * 
************************************************************/
/************************************************************
SQL代码：
...
namespace AgileFrame.Orm.PersistenceLayer.Model
{
    /// <summary>
    /// <para>学生作业关联表</para>
    /// <para>与Xt_student_task数据表对应的实体对象。</para>
    ...
    public class Xt_student_task : ITableImplement
    {
        ...
        /// <summary> 作业ID:[CtrlTypeDic-{InputString}] Attribute_IsNotNull </summary>
        ...
        /// <summary> 作业文件:[CtrlTypeDic-{InputString}] Attribute_IsNotNull </summary>
        ...
        /// <summary> 作业结果:[CtrlTypeDic-{InputString}] Attribute_IsNotNull </summary>
        ...
        /// <summary> 审批状态:[CtrlTypeDic-{InputString}] Attribute_IsNotNull </summary>
        ...
        /// <summary> 审批人:[CtrlTypeDic-{InputString}] Attribute_IsNotNull </summary>
        ...
        /// <summary> 审批时间:[CtrlTypeDic-{InputDateTime}] Attribute_IsNotNull </summary>
        ...
        /// <summary> 作业文件:[CtrlTypeDic-{InputString}]，推荐使用 "_"符号开头 </summary>
        ...
        /// <summary> 作业结果:[CtrlTypeDic-{InputString}]，推荐使用 "_"符号开头 </summary>
        ...
        /// <summary> 审批状态:[CtrlTypeDic-{InputString}]，推荐使用 "_"符号开头 </summary>
        ...
        /// <summary> 审批人:[CtrlTypeDic-{InputString}]，推荐使用 "_"符号开头 </summary>
        ...
        /// <summary> 审批时间:[CtrlTypeDic-{InputDateTime}]，推荐使用 "_"符号开头 </summary>
        ...
        public class Attribute
        {
            ...
            /// <summary>审批时间:[CtrlTypeDic-{InputDateTime}]</summary>
        ...
        {
            return (Xt_student_task)this.MemberwiseClone(); //浅复制
        }
        #endregion
