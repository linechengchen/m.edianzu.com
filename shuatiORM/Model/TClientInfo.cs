/************************************************************
  ...
  Description:    数据表TClientInfo对应的业务逻辑层TClientInfo
  Version:         2.1.0.0
  * 对此文件的更改可能会导致不正确的行为，并且如果
     重新生成代码，这些更改将会丢失。您可以扩展该类
 * 实现自己的 TClientInfo_Entity:TClientInfo
 * 
************************************************************/
/************************************************************
SQL代码：
...
namespace AgileFrame.Orm.PersistenceLayer.Model
{
    /// <summary>
    /// <para>你的客户信息</para>
    /// <para>与TClientInfo数据表对应的实体对象。</para>
    ...
    public class TClientInfo : ITableImplement
    {
        ...
        /// <summary> 源1:[CtrlTypeDic-{InputString}] Attribute_IsNotNull </summary>
        ...
        /// <summary> PID源1:[CtrlTypeDic-{InputString}] Attribute_IsNotNull </summary>
        ...
        /// <summary> 源1:[CtrlTypeDic-{InputString}]，推荐使用 "_"符号开头 </summary>
        ...
        /// <summary> PID源1:[CtrlTypeDic-{InputString}]，推荐使用 "_"符号开头 </summary>
        ...
        public class Attribute
        {
            ...
            /// <summary>源1:[CtrlTypeDic-{InputString}]</summary>
            ...
            /// <summary>PID源1:[CtrlTypeDic-{InputString}]</summary>
        ...
        {
            return (TClientInfo)this.MemberwiseClone(); //浅复制
        }
        #endregion
