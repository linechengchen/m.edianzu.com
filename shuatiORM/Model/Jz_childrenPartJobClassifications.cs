/************************************************************
  ...
  Description:    数据表Jz_childrenPartJobClassifications对应的业务逻辑层Jz_childrenPartJobClassifications
  Version:         2.1.0.0
  * 对此文件的更改可能会导致不正确的行为，并且如果
     重新生成代码，这些更改将会丢失。您可以扩展该类
 * 实现自己的 Jz_childrenPartJobClassifications_Entity:Jz_childrenPartJobClassifications
 * 
************************************************************/
/************************************************************
SQL代码：
...
namespace AgileFrame.Orm.PersistenceLayer.Model
{
    /// <summary>
    /// <para>兼职分类</para>
    /// <para>与Jz_childrenPartJobClassifications数据表对应的实体对象。</para>
    ...
    public class Jz_childrenPartJobClassifications : ITableImplement
    {
        ...
        {
            return (Jz_childrenPartJobClassifications)this.MemberwiseClone(); //浅复制
        }
        #endregion
