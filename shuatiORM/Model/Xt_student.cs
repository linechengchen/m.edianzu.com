/************************************************************
  ...
  Description:    数据表Xt_student对应的业务逻辑层Xt_student
  Version:         2.1.0.0
  * 对此文件的更改可能会导致不正确的行为，并且如果
     重新生成代码，这些更改将会丢失。您可以扩展该类
 * 实现自己的 Xt_student_Entity:Xt_student
 * 
************************************************************/
/************************************************************
SQL代码：
...
namespace AgileFrame.Orm.PersistenceLayer.Model
{
    /// <summary>
    /// <para>学生用户信息表</para>
    /// <para>与Xt_student数据表对应的实体对象。</para>
    ...
    public class Xt_student : ITableImplement
    {
        ...
        /// <summary> 最后登录类型:[CtrlTypeDic-{InputString}] Attribute_IsNotNull </summary>
        ...
        /// <summary> 头像路径:[CtrlTypeDic-{Text}] Attribute_IsNotNull </summary>
        public string _Head
        {            
        ...
        /// <summary> 最后登录类型:[CtrlTypeDic-{InputString}]，推荐使用 "_"符号开头 </summary>
        ...
        /// <summary> 头像路径:[CtrlTypeDic-{Text}]，推荐使用 "_"符号开头 </summary>
        public string Head
        {
        ...
        public class Attribute
        {
            ...
            /// <summary>最后登录类型:[CtrlTypeDic-{InputString}]</summary>
            ...
            /// <summary>头像路径:[CtrlTypeDic-{Text}]</summary>
        ...
        {
            return (Xt_student)this.MemberwiseClone(); //浅复制
        }
        #endregion
