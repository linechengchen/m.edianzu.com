/************************************************************
  ...
  Description:    数据表Jz_userTagVOs对应的业务逻辑层Jz_userTagVOs
  Version:         2.1.0.0
  * 对此文件的更改可能会导致不正确的行为，并且如果
     重新生成代码，这些更改将会丢失。您可以扩展该类
 * 实现自己的 Jz_userTagVOs_Entity:Jz_userTagVOs
 * 
************************************************************/
/************************************************************
SQL代码：
...
namespace AgileFrame.Orm.PersistenceLayer.Model
{
    /// <summary>
    /// <para></para>
    /// <para>与Jz_userTagVOs数据表对应的实体对象。</para>
    ...
    public class Jz_userTagVOs : ITableImplement
    {
        ...
        /// <summary> 标签类型:[Enum-{USER_TAG:用户标签},{SYSTEM_TAG:系统标签}][CtrlTypeDic-{SelectDrop}] Attribute </summary>
        ...
        /// <summary> 标签类型:[Enum-{USER_TAG:用户标签},{SYSTEM_TAG:系统标签}][CtrlTypeDic-{SelectDrop}]，推荐使用 "_"符号开头 </summary>
        ...
        public class Attribute
        {
            ...
            /// <summary>标签类型:[Enum-{USER_TAG:用户标签},{SYSTEM_TAG:系统标签}][CtrlTypeDic-{SelectDrop}]</summary>
        ...
        {
            return (Jz_userTagVOs)this.MemberwiseClone(); //浅复制
        }
        #endregion
